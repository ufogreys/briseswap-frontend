    ...
    switch (step) {
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active BriseSwap Profile to take part in an IFO!')}
            </Text>
            {isStepValid ? (
      ...
      case 1:
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t('Get BSWAP-BRISE LP Tokens')}
            </Heading>
            <Text color="textSubtle" small>
              {t('Stake BSWAP and BRISE in the liquidity pool to get LP tokens.')} <br />
              {t('You’ll spend them to buy IFO sale tokens.')}
            </Text>
            <Button
              as={Link}
              external
              href={`${BASE_ADD_LIQUIDITY_URL}/BRISE/0xF26006408112be347c23FDBa03F7bC3566519655`}
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent BSWAP-BRISE LP tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
